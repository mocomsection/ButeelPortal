...
export const routes = [
  ...
  { path: "/catalog/release",         element: <ReleaseDetailScreen /> },
  { path: "/submit",                  element: <SubmitStep1 /> },
  { path: "/submit/music",            element: <MusicWizard /> },
  ...
  { path: "/submit/audiobook-info",   element: <SubmitAudioBookInfoScreen /> },
  { path: "/submit/film-info",        element: <SubmitFilmInfoScreen /> },
